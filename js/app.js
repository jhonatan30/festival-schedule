...
const MAP_LAYOUT = {
  ...
  'Páramo':           { x:36,  y:108, w:90,  h:50 },
  'Resident Advisor': { x:148, y:148, w:90,  h:50 },
};
...
function renderMapSVG(highlightStage, compact, routeMode) {
  ...
  return `<svg viewBox="0 0 380 215" class="${svgClass}"${svgId}>
    ...
    <line x1="54" y1="68" x2="68" y2="108" stroke="rgba(255,184,208,.09)" stroke-width="1.5" stroke-dasharray="5,4"/>
    <line x1="133" y1="68" x2="178" y2="148" stroke="rgba(255,184,208,.09)" stroke-width="1.5" stroke-dasharray="5,4"/>
    <line x1="126" y1="133" x2="148" y2="158" stroke="rgba(255,184,208,.09)" stroke-width="1.5" stroke-dasharray="5,4"/>
